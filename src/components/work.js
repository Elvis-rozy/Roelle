...
const Work =({stat, setStat, workStat, setWorkStat})=>{
  ...
  const [projects] = useState([
    {id: "O1", num: 1, name: "Codei", year: "Dec 2024", mainDesc: "With it's modern yet confident design, Codei was made for a web design and development agency that strives to build long-term relationships with their clients, helping them achieve their online goals and grow their businesses. Their services include: Website Design, Website Development, E-commerce Solutions, graphic design, Optimization, and Content Management Systems (CMS).", desktopImg: "./media/projectDetails/codei.png", mobileImg: "./media/projectDetails/codei-2.png", stackImg1: "./media/icons/react.png", stackImg2: "./media/icons/css.png", stackImg3: "./media/icons/github.png", stackImg4: "./media/icons/api.jpeg", stackImg5: "./media/icons/figma.png", codeLink: "https://github.com/Elvis-rozy/CODEi", webLink: "https://code-i.vercel.app", desc: "A Web design, development and optimization company's website", previewImg: "../media/projects/codei.png"},
    {id: "O2", num: 2, name: "Vvyd", year: "Feb 2025", mainDesc: "Vvyd was developed to be a source of endless Inspiration, through a vast and constantly updated collection of wallpapers, carefully curated to spark your imagination. Inspired by Pinterest, It allows you to easily find and save your favorite wallpapers, and is optimized for various devices and screen resolutions.", desktopImg: "./media/projectDetails/vvyd.png", mobileImg: "./media/projectDetails/vvyd-2.png", stackImg1: "./media/icons/html.png", stackImg2: "./media/icons/js.png", stackImg3: "./media/icons/css.png", stackImg4: "./media/icons/figma.png", stackImg5: "./media/icons/github.png", codeLink: "https://github.com/Elvis-rozy/Vvyd", webLink: "https://vvyd.vercel.app", desc: "A Wallpaper website", previewImg: "../media/projects/vvyd.png"},
    {id: "O3", num: 3, name: "Audivo", year: "jan 2025", mainDesc: "As a media streaming webapp with dual options, Audivo is your premier destination for streaming free music and videos which provides a vast library of high-quality content, while supporting artists and creators. It's features include: A Huge Music Library, Video Streaming, Content Discovery, and Offline Listening.", desktopImg: "./media/projectDetails/audivo.png", mobileImg: "./media/projectDetails/audivo-2.png", stackImg1: "./media/icons/html.png", stackImg2: "./media/icons/js.png", stackImg3: "./media/icons/css.png", stackImg4: "./media/icons/figma.png", stackImg5: "./media/icons/github.png", codeLink: "https://github.com/Elvis-rozy/Audivo", webLink: "https://audivo.vercel.app", desc: "A Media streaming web-app (music and videos)", previewImg: "../media/projects/audivo.png"},
    {id: "O4", num: 4, name: "Candela", year: "dec 2024", mainDesc: "Construction at it's best is just art, and at Candela, they are dedicated to delivering high-quality projects on time and within budget. With a team of experts and stacked years of experience in the industry, they're committed to providing exceptional service to clients. The website features their services which include: General Contracting, Construction Management, Design-Build, Renovation and Remodeling, and Landscaping.", desktopImg: "./media/projectDetails/candela.png", mobileImg: "./media/projectDetails/candela-2.png", stackImg1: "./media/icons/react.png", stackImg2: "./media/icons/css.png", stackImg3: "./media/icons/github.png", stackImg4: "./media/icons/api.jpeg", stackImg5: "./media/icons/figma.png", codeLink: "https://github.com/Elvis-rozy/Candela", webLink: "https://candela-tawny.vercel.app", desc: "A start-up construction company's website", previewImg: "../media/projects/candela.png"},
    {id: "O5", num: 5, name: "Roelle", year: "May 2024", mainDesc: "This of course is my portfolio website, written with React, CSS3 and SASS. It showcases my recent projects, both personal and group works that depict my level of experience and overall competence. I hope you find it interesting and decide to give me a call for a job placement or collaborative work.", desktopImg: "./media/projectDetails/roelle.png", mobileImg: "./media/projectDetails/roelle-2.png", stackImg1: "./media/icons/react.png", stackImg2: "./media/icons/css.png", stackImg3: "./media/icons/github.png", stackImg4: "./media/icons/api.jpeg", stackImg5: "./media/icons/figma.png", codeLink: "https://github.com/Elvis-rozy/Roelle", webLink: "https://roelle.vercel.app", desc: "My Portfolio website", previewImg: "../media/projects/roelle.png"},
    {id: "O6", num: 6, name: "BigBite", year: "Nov 2024", mainDesc: " BigBite is a snack shop's website that offers features like: Snack Subscription (Offering customers the option to subscribe to regular snack deliveries, with customizable frequency and snack selection, Snack Recommendations, Customer Reviews, Promotions and Discounts, Secure Payment Processing through reputable third-party providers, such as Stripe or PayPal. With the warm and inviting orange that stimulates appetite and energy, it features mouth-watering foods that are both healthy and satisfying.", desktopImg: "./media/projectDetails/bigbite.png", mobileImg: "./media/projectDetails/bigbite-2.png", stackImg1: "./media/icons/html.png", stackImg2: "./media/icons/js.png", stackImg3: "./media/icons/css.png", stackImg4: "./media/icons/figma.png", stackImg5: "./media/icons/github.png", codeLink: "https://github.com/Elvis-rozy/BigBite", webLink: "https://big-bite-self.vercel.app", desc: "A local-based Snack shop landing page", previewImg: "../media/projects/bigBite.png"},
