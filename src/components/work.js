...
const Work =({stat, setStat, workStat, setWorkStat})=>{
  ...
  const [projects] = useState([
    ...
    {id: "O5", num: 5, name: "Candela", year: "dec 2024", mainDesc: "project description", desktopImg: "./media/projectDetails/candela.png", mobileImg: "./media/projectDetails/candela-2.png", stackImg1: "./media/icons/figma.png", stackImg2: "./media/icons/figma.png", stackImg3: "./media/icons/figma.png", codeLink: "", webLink: "https://candela-tawny.vercel.app", desc: "A start-up construction company's website", previewImg: "../media/projects/candela.png"},
